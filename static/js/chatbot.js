    ...
    const RESPONSES = {
        ...
        horarios: {
            text: '<i class="bi bi-clock-fill"></i> <strong>Nuestros horarios de atención son:</strong><br><br>' +
                '<i class="bi bi-calendar-week-fill"></i> <strong>Lunes a Viernes:</strong> 8:00 AM – 6:00 PM<br>' +
                '<i class="bi bi-calendar-week-fill"></i> <strong>Sábados:</strong> 9:00 AM – 4:00 PM<br>' +
                '<i class="bi bi-calendar-week-fill"></i> <strong>Domingos:</strong> 10:00 AM – 2:00 PM<br><br>' +
                '<i class="bi bi-exclamation-triangle-fill"></i> Los días feriados pueden tener horario especial. Te recomendamos consultarnos por WhatsApp.',
